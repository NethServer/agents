...
- `/nethserver-qa` — execute issue QA cases on NS8 test environments and report results
...
| `nethserver-admin`, `nethserver-ns8-core`, `nethserver-ns8-module`, `nethserver-qa` | none — these need full reasoning |
